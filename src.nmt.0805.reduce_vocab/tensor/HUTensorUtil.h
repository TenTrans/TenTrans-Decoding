...
public:
    ...
    static HUShape GetCopyColsShape(HUPtr<HUTensor> a, const std::vector<size_t>& indices);
    ...
    static HUPtr<HUTensor> CopyCols(HUPtr<HUTensor> in, const std::vector<size_t>& indices, HUPtr<HUMemPool> mem);
