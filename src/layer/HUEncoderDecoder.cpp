...
HUPtr<HUDecoderState> HUEncoderDecoder::Step(HUPtr<HUDecoderState> state, size_t* hypIndices, int selIdxSize, std::vector<size_t>& embIndices, int beamSize, int realDimBatch, uint8_t* isAllDone)
{
