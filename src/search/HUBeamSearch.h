...
public:
	HUBeamSearch(HUPtr<HUConfig> options, HUPtr<HUEncoderDecoder> encdec, size_t beamSize, int trgEosId, int trgUnkId, HUPtr<HUMemPool> memoryPool, HUPtr<HUDevice> device)
      : options_(options), encdec_(encdec), beamSize_(beamSize),  trgEosId_(trgEosId), trgUnkId_(trgUnkId), memPool_(memoryPool), device_(device) {}
